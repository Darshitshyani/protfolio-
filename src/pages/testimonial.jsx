  ...
  useEffect(() => {
    ...
    const animateScroll = () => {
      if (scrollContainer) {
        ...
        if (scrollPositionRef.current <= -scrollContainer.scrollHeight / 2) {
  ...
  return (
    <div className="py-16 px-4 bg-gradient-to-br from-slate-50 to-slate-100 font-sans pt-[120px] ">
      <div className="max-w-6xl mx-auto">
        ...
        <p className="text-md text-center text-black-600 mb-12">Hear from those who have worked with me</p>
...
w-full h-full flex flex-col justify-between
    bg-cover bg-center
    [background-image:url('../untils/images/client1.png')]
  "
                  onClick={playVideo}
                >
...
>
  ...
  <path 
    fill="#fff" 
    d="M40 30L70 50L40 70Z" 
  />
</svg>
                 
                  </div>
                  <div className='mb-5 text-start '>
                    <p className='text-primary-main font-semibold text-common-white'>{videodetails?.name}</p>
                ...
                <div className="w-full h-full">
                  <Video
                    width="100%"
                    height="100%"
                    src={videodetails?.url} // <-- Remove 'public/' prefix
          ...
          {/* Text Testimonials Section with Infinite Scroll */}
          <div className="w-full mt-[50px] sm:mt-0 lg:w-3/5
                      ...
                      <div className="border-t border-black-200 pt-3 flex items-center justify-between w-full">
                        ...
                        {testimonial?.url && (
                          <span
                            ...
                            onClick={() => { setVideoIndex(index); setIsVideoPlaying(false); }}
                          >
                            <svg
                              width="28"
                              height="28"
